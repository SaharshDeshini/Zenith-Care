...
//     <div className="page fade-in">
    ...
    //         <button className="nav-primary">Book Now ➡️</button>
    //       </div>
    //     </nav>
      ...
      {showLogin ? (
        ...
        <div className="page fade-in">
            ...
            <nav className="navbar">
              ...
              <div className="nav-right">
                <button className="nav-pill"><a href="#how-it-works">How it works</a></button>
                <button className="nav-primary" onClick={() => setShowLogin(true)}>Book Now ➡️</button>
              </div>
            </nav>
            ...
            <section className="hero">
              ...
              <button className="hero-cta">
                <span  onClick={() => setShowLogin(true)}>Find Hospital</span>
                <span className="cta-icon">→</span>
              </button>
